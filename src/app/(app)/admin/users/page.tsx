...
import { generateAssignmentNotificationEmail } from '@/ai/flows/assignment-notification-flow'; // Updated import
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
    ...
    try {
      ...
      for (const project of newlyAssignedProjects) {
        ...
        try {
          ...
          const emailContent = await generateAssignmentNotificationEmail({ 
          ...
          await addDoc(mailCollectionRef, {
            ...
            message: {
              ...
              html: emailContent.emailBody, // Use the HTML body generated by Genkit
            },
          });
          ...
          toast({
            ...
            description: `An assignment email for ${targetUser.name} regarding ${project.name} has been queued for sending. Subject: ${emailContent.emailSubject}`,
            duration: 8000,
          });
