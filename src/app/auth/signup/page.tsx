...
export default function SignupPage() {
  ...
  const disabled = isLoading || isLoadingGoogle || authLoading;
  ...
  return (
    <Card className="w-full max-w-md shadow-xl">
      ...
      <CardContent>
        ...
        <Button variant="outline" className="w-full rounded-lg" onClick={handleGoogleSignup} disabled={disabled}>
          {isLoadingGoogle ? <Loader2 className="animate-spin mr-2 h-4 w-4" /> : (
