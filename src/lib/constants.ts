...
import { LayoutDashboard, FileText, Users, HardHat, TestTube2, Settings, UserCircle, Briefcase, CalendarDays, BarChart3, Settings2, FlaskConical, Map, Sparkles } from 'lucide-react';
...
export const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { href: '/analytics', label: 'Analyses & Performance', icon: BarChart3, roles: ['ADMIN', 'SUPERVISOR'] },
  {
    ...
    children: [
      ...
      { href: '/admin/recommendations', label: 'Recommandations', icon: Sparkles, roles: ['ADMIN'] },
      { href: '/admin/overview', label: 'Qui est où', icon: Map, roles: ['ADMIN'] },
